...
The extension requires a [`.graphqlconfig`](https://github.com/graphcool/graphql-config) file to know which files to scan for queries, and what schema to use to interpret them.
...
The syntax files are copied from [Kumar Harsh's GraphQL for VSCode extension](https://github.com/kumarharsh/graphql-for-vscode).